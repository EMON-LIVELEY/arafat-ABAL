...
for xd in range(10000):
    ...
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
os.system('xdg-open https://github.com/EMON-LIVELEY')
logo = ("""\033[38;5;48m
...
\033[38;5;96m\033[47m B \x1b[0m\033[38;5;196m DEVELOPER   :   EMON-LIVELEY
\033[38;5;97m\033[47m O \x1b[0m\033[38;5;197m GITHUB      :   EMON-LIVELEY
...
class Main:
    def __init__(self):
        ...
        print("\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        Mumit =input("[?] Choose : ")
        os.system('xdg-open https://www.facebook.com/profile.php?id=100078731167665&mibextid=zLoPMf')
        if Mumit in ["1", "01"]:
            num()
        if Mumit in ["2","02"]:
            gml()
